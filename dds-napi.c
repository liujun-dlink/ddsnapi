 ...
 * 公开napi方法
 */
#define DECLARE_NAPI_METHOD(name, func) { name, 0, func, 0, 0, 0, napi_writable | napi_configurable, 0 }
...
NAPI_MODULE_INIT(/*env, exports*/) {
	...
	napi_property_descriptor bindings[] = {
		DECLARE_NAPI_METHOD("unTar", un_tar),
		DECLARE_NAPI_METHOD("unTarSync", un_tar_sync),
		DECLARE_NAPI_METHOD("killConsoles", kill_consoles),
		DECLARE_NAPI_METHOD("killConsolesSync", kill_consoles_sync),
		DECLARE_NAPI_METHOD("getUptime", get_uptime),
		DECLARE_NAPI_METHOD("getUptimeSync", get_uptime_sync),
		DECLARE_NAPI_METHOD("getFotaStatus", get_fotaStatus),
		DECLARE_NAPI_METHOD("getFotaStatusSync", get_fotaStatus_sync),
		DECLARE_NAPI_METHOD("setPowerLed", set_power_led),
		DECLARE_NAPI_METHOD("setPowerLedSync", set_power_led_sync),
		DECLARE_NAPI_METHOD("setSsoLed", set_sso_led),
		DECLARE_NAPI_METHOD("setSsoLedSync", set_sso_led_sync),
		DECLARE_NAPI_METHOD("getFtpData", get_ftp_data),
		DECLARE_NAPI_METHOD("getFtpDataSync", get_ftp_data_sync),
		DECLARE_NAPI_METHOD("setFtpData", set_ftp_data),
		DECLARE_NAPI_METHOD("setFtpDataSync", set_ftp_data_sync),
		DECLARE_NAPI_METHOD("getPerformance", get_performance),
		DECLARE_NAPI_METHOD("getPerformanceSync", get_performance_sync),
		DECLARE_NAPI_METHOD("getSystemInfo", get_system_info),
		DECLARE_NAPI_METHOD("getSystemInfoSync", get_system_info_sync),
		DECLARE_NAPI_METHOD("getHddFlag", get_hdd_flag),
		DECLARE_NAPI_METHOD("getHddFlagSync", get_hdd_flag_sync),
		DECLARE_NAPI_METHOD("setHddFlag", set_hdd_flag),
		DECLARE_NAPI_METHOD("setHddFlagSync", set_hdd_flag_sync),
		DECLARE_NAPI_METHOD("setDatetime", set_datetime),
		DECLARE_NAPI_METHOD("setDatetimeSync", set_datetime_sync),
		DECLARE_NAPI_METHOD("getDatetime", get_datetime),
		DECLARE_NAPI_METHOD("getDatetimeSync", get_datetime_sync),
		DECLARE_NAPI_METHOD("setTimezone", set_timezone),
		DECLARE_NAPI_METHOD("setTimezoneSync", set_timezone_sync),
		DECLARE_NAPI_METHOD("getTimezone", get_timezone),
		DECLARE_NAPI_METHOD("getTimezoneSync", get_timezone_sync),
		DECLARE_NAPI_METHOD("setDaylightSaving", set_daylight_saving),
		DECLARE_NAPI_METHOD("setDaylightSavingSync", set_daylight_saving_sync),
		DECLARE_NAPI_METHOD("getDaylightSaving", get_daylight_saving),
		DECLARE_NAPI_METHOD("getDaylightSavingSync", get_daylight_saving_sync),
		DECLARE_NAPI_METHOD("setCityDatetime", set_city_datetime),
		DECLARE_NAPI_METHOD("setCityDatetimeSync", set_city_datetime_sync),
		DECLARE_NAPI_METHOD("getCityDatetime", get_city_datetime),
		DECLARE_NAPI_METHOD("getCityDatetimeSync", get_city_datetime_sync),
		DECLARE_NAPI_METHOD("getCityDst", get_city_dst),
		DECLARE_NAPI_METHOD("getCityDstSync", get_city_dst_sync),
		DECLARE_NAPI_METHOD("getHWVersion", get_hw_version),
		DECLARE_NAPI_METHOD("getHWVersionSync", get_hw_version_sync),
		DECLARE_NAPI_METHOD("getNCVersion", get_nc_version),
		DECLARE_NAPI_METHOD("getNCVersionSync", get_nc_version_sync),
		DECLARE_NAPI_METHOD("setFOTASetting", set_fota_setting),
		DECLARE_NAPI_METHOD("setFOTASettingSync", set_fota_setting_sync),
		DECLARE_NAPI_METHOD("getFirmwareVersion", get_firmware_version),
		DECLARE_NAPI_METHOD("getFirmwareVersionSync", get_firmware_version_sync),
		DECLARE_NAPI_METHOD("getFirmwareVersionFull", get_firmware_version_full),
		DECLARE_NAPI_METHOD("getFirmwareVersionFullSync", get_firmware_version_full_sync),
		DECLARE_NAPI_METHOD("getFirmwareInfo", get_firmware_info),
		DECLARE_NAPI_METHOD("getFirmwareInfoSync", get_firmware_info_sync),
		DECLARE_NAPI_METHOD("getDeviceUUID", get_device_uuid),
		DECLARE_NAPI_METHOD("getDeviceUUIDSync", get_device_uuid_sync),
		DECLARE_NAPI_METHOD("getFirmwareUpgradeStatus", get_firmware_upgrade_status),
		DECLARE_NAPI_METHOD("getFirmwareUpgradeStatusSync", get_firmware_upgrade_status_sync),
		DECLARE_NAPI_METHOD("setFOTAUpdateStatus", set_fota_update_status),
		DECLARE_NAPI_METHOD("setFOTAUpdateStatusSync", set_fota_update_status_sync),
		DECLARE_NAPI_METHOD("getFOTASetting", get_fota_setting),
		DECLARE_NAPI_METHOD("getFOTASettingSync", get_fota_setting_sync),
		DECLARE_NAPI_METHOD("getFOTAUpdateStatus", get_fota_update_status),
		DECLARE_NAPI_METHOD("getFOTAUpdateStatusSync", get_fota_update_status_sync),
		DECLARE_NAPI_METHOD("setFirmwareUpgradeStatus", set_firmware_upgrade_status),
		DECLARE_NAPI_METHOD("setFirmwareUpgradeStatusSync", set_firmware_upgrade_status_sync),
		DECLARE_NAPI_METHOD("analyzeFirmwareInfo", analyze_firmware_info),
		DECLARE_NAPI_METHOD("analyzeFirmwareInfoSync", analyze_firmware_info_sync),
		DECLARE_NAPI_METHOD("setAdminPassword", set_admin_password),
   		DECLARE_NAPI_METHOD("setAdminPasswordSync", set_admin_password_sync),
		DECLARE_NAPI_METHOD("save", cli_save),
		DECLARE_NAPI_METHOD("saveSync", cli_save_sync),
		DECLARE_NAPI_METHOD("getDeviceName", get_device_name),
		DECLARE_NAPI_METHOD("getDeviceNameSync", get_device_name_sync),
		DECLARE_NAPI_METHOD("setDeviceName", set_device_name),
		DECLARE_NAPI_METHOD("setDeviceNameSync", set_device_name_sync),
		DECLARE_NAPI_METHOD("getWebAccessPort", get_web_access_port),
		DECLARE_NAPI_METHOD("getWebAccessPortSync", get_web_access_port_sync),
		DECLARE_NAPI_METHOD("setWebAccessPort", set_web_access_port),
		DECLARE_NAPI_METHOD("setWebAccessPortSync", set_web_access_port_sync),
		DECLARE_NAPI_METHOD("getNginxAccessPort", get_nginx_access_port),
		DECLARE_NAPI_METHOD("getNginxAccessPortSync", get_nginx_access_port_sync),
		DECLARE_NAPI_METHOD("setWebAccessPort", set_nginx_access_port),
		DECLARE_NAPI_METHOD("setNginxAccessPortSync", set_nginx_access_port_sync),
		DECLARE_NAPI_METHOD("getNvrVersion", get_nvr_version),
		DECLARE_NAPI_METHOD("getNvrVersionSync", get_nvr_version_sync),
		DECLARE_NAPI_METHOD("setMACAddress", set_MAC_address),
		DECLARE_NAPI_METHOD("setMACAddressSync", set_MAC_address_sync),
		DECLARE_NAPI_METHOD("setConsoleSetting", set_console_setting),
		DECLARE_NAPI_METHOD("setConsoleSettingSync", set_console_setting_sync),
		DECLARE_NAPI_METHOD("getConsoleSetting", get_console_setting),
		DECLARE_NAPI_METHOD("getConsoleSettingSync", get_console_setting_sync),
		DECLARE_NAPI_METHOD("upload", ftp_upload),
		DECLARE_NAPI_METHOD("uploadSync", ftp_upload_sync),
		DECLARE_NAPI_METHOD("download", ftp_download),
		DECLARE_NAPI_METHOD("downloadSync", ftp_download_sync),
		DECLARE_NAPI_METHOD("checkHeaderAndPayload", check_header_and_payload),
		DECLARE_NAPI_METHOD("checkHeaderAndPayloadSync", check_header_and_payload_sync),
		DECLARE_NAPI_METHOD("setLANSetting", set_LAN_setting),
		DECLARE_NAPI_METHOD("setLANSettingSync", set_LAN_setting_sync),
		DECLARE_NAPI_METHOD("getLANSetting", get_LAN_setting),
		DECLARE_NAPI_METHOD("getLANSettingSync", get_LAN_setting_sync),
		DECLARE_NAPI_METHOD("setLANSettingIpv6", set_LAN_setting_ipv6),
		DECLARE_NAPI_METHOD("setLANSettingIpv6Sync", set_LAN_setting_ipv6_sync),
		DECLARE_NAPI_METHOD("getLANSettingIpv6", get_LAN_setting_ipv6),
		DECLARE_NAPI_METHOD("getLANSettingIpv6Sync", get_LAN_setting_ipv6_sync)
	};
